...
public class TambahFeedback extends AppCompatActivity implements View.OnClickListener{
    TextView tvFeedback, tvKomentar;
    String StringImage;
    ImageView ivPhoto;
    Uri UriPhoto;
    Bitmap BitPhoto;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvFeedback = findViewById(R.id.tv_nama);
    ...
    private void sendData() {
        StringRequest srSendData = new StringRequest(Request.Method.POST, "http://192.168.43.229/feedback/insert.php", new Response.Listener<String>() {
            @Override
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(TambahFeedback.this, error.getMessage().toString(), Toast.LENGTH_LONG).show();
            }
        }){
            @Override
            protected Map<String, String> getParams() {
                Map<String, String> map = new HashMap<>();
                map.put("nama", tvFeedback.getText().toString());
                map.put("komentar", tvKomentar.getText().toString());
